      ...
      <div style={{ '--i': 2 }}>
        <div className="nav-machines-wrap">
          <div className={`nav-link-row ${isOurMachinesActive ? 'active' : ''}`}>
            ...
            <span className={`nav-link-arrow${mobileMachinesOpen ? ' open' : ''}`} onClick={() => { setMobileMachinesOpen(!mobileMachinesOpen); fetchCategories(); }}>&#9656;</span>
          </div>
        ...
        {isMobile() ? renderMobileMenu() : (
          <>
            ...
            <div ref={ddRef} style={{ position: 'relative' }}
              onMouseEnter={() => { setDropdownOpen(true); fetchCategories(); }}
