...
const cancelBtn = {
  flex: 1, padding: 'clamp(10px, 1.2vw, 14px)',
...
export default function ConfirmModal({ open, onConfirm, onCancel, title: msgTitle, message }) {
  return (
    <AnimatePresence>
      {open && (
        ...
        >
          ...
          >
            ...
            <div style={iconWrap}>
              <svg viewBox="0 0 24 24" width="28" height="28" fill="none" stroke={gold} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
                <path d="M3 6h18" /><path d="M8 6V4h8v2" /><rect x="4" y="6" width="16" height="14" rx="2" /><path d="M10 11v5" /><path d="M14 11v5" />
              </svg>
            </div>

            <h3 style={title}>{msgTitle || 'Delete this post?'}</h3>
            <p style={subtitle}>{message || 'This action cannot be undone.'}</p>
